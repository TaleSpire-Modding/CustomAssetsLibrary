    ...
    public partial class CustomAssetsPlugin : BaseUnityPlugin
    {
        public static partial class Data
        {
            ...
            public sealed class CreatureType
            {
                ...
                public IconType Icon { get; set; } = default(IconType);
                public List<float> HeadPos { get; set; } = new List<float>{0,1,0};
                public List<float> TorchPos { get; set; } = new List<float>{0, 1, 0};
                public List<float> SpellPos { get; set; } = new List<float>{0, 1, 0};
                public List<float> HitPos { get; set; } = new List<float>{0, 1, 0};
            }
